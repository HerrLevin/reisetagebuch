...
import type { RemotePostBoostedData } from '@/types/activitypub';
...
const data = props.notification.data as unknown as RemotePostBoostedData;
</script>
<template>
    <NotificationLayout :notification="notification">
        <div>
            <Repeat2 class="text-green-500" />
        </div>
        <div class="flex-1">
            <div class="text-sm">
                <div class="avatar">
                ...
                {{
                    t('notifications.remote_boosted.lead', {
