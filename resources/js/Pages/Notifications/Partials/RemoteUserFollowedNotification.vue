...
import type { RemoteUserFollowedData } from '@/types/activitypub';
...
const data = props.notification.data as unknown as RemoteUserFollowedData;
</script>
<template>
    <NotificationLayout :notification="notification">
        ...
        <div class="flex-1">
            <div class="text-sm">
                ...
                {{
                    t('notifications.remote_followed.lead', {
