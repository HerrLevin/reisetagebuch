...
class LocationController extends Controller
{
    ...
    #[OA\Post(
        ...
        parameters: [
            ...
            new OA\Parameter(name: 'X-RTB-DISALLOW-HISTORY', description: 'Set to true to disallow storing this location in history', in: 'header', required: false, schema: new OA\Schema(type: 'boolean')),
            new OA\Parameter(name: 'X-RTB-ALLOW-HISTORY', description: 'Set to true to allow storing this location in history', in: 'header', required: false, schema: new OA\Schema(type: 'boolean')),
